...
package com.lazycece.zsagent.infra.acl.producer;
...
import com.lazycece.zsagent.domain.order.event.OrderEventHandler;
 ...
 */
@Slf4j
@EventHandler(type = "com.lazycece.zsagent.domain.order.event.OrderEventModel")
